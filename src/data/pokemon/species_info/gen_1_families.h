...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_BUTTERFREE}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_BLISSEY}),
    },
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_SNORLAX}),
    },
#endif //P_GEN_4_CROSS_EVOS
