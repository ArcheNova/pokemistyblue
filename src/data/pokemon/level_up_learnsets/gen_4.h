...
static const struct LevelUpMove sBulbasaurLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE), // 50 (SELECTED) N
    LEVEL_UP_MOVE( 3, MOVE_GROWL), // ATK DOWN (BOTH)
    LEVEL_UP_MOVE( 5, MOVE_VINE_WHIP), // 50 (SELECTED)
    LEVEL_UP_MOVE( 7, MOVE_LEECH_SEED), // HEAL * DMG
    LEVEL_UP_MOVE( 9, MOVE_ACID_SPRAY), // 40 (SELECTED)
    LEVEL_UP_MOVE(11, MOVE_POISON_POWDER), // POISON
    LEVEL_UP_MOVE(11, MOVE_SLEEP_POWDER), // SLEEP
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN), // 90 (SELECTED) N
    LEVEL_UP_MOVE(17, MOVE_RAZOR_LEAF), // 60 (BOTH)
    LEVEL_UP_MOVE(19, MOVE_WORRY_SEED), // Fähigkeit wird vergesen
    LEVEL_UP_MOVE(19, MOVE_SWEET_SCENT), // EVA DOWN 2 (BOTH)
    LEVEL_UP_MOVE(19, MOVE_GROWTH), // ATK + SATK Up
    LEVEL_UP_MOVE(24, MOVE_SEED_BOMB), // 80 (SELECTED)
    LEVEL_UP_MOVE(27, MOVE_POISON_JAB), // 80 (SELECTED)
    LEVEL_UP_MOVE(31, MOVE_SLUDGE_BOMB), // 90 (SELECTED)
    LEVEL_UP_MOVE(34, MOVE_DOUBLE_EDGE), // 120 (SELECTED) N
    LEVEL_UP_MOVE(38, MOVE_PETAL_DANCE), // 100 (RANDOM) 2-3 Turns
    LEVEL_UP_MOVE(42, MOVE_SYNTHESIS), // Heal
    LEVEL_UP_MOVE(45, MOVE_SOLAR_BEAM), // 120 (SELECTED) Aufladen
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCharmanderLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH), // 50 (SELECTED) N
    LEVEL_UP_MOVE( 3, MOVE_GROWL), // ATK DOWN (BOTH)
    LEVEL_UP_MOVE( 5, MOVE_EMBER), // 50 (SELECTED)
    LEVEL_UP_MOVE( 7, MOVE_SMOKESCREEN), // ACC DOWN (BOTH)
    LEVEL_UP_MOVE( 9, MOVE_METAL_CLAW), // 50 (SELECTED) M
    LEVEL_UP_MOVE(11, MOVE_SCARY_FACE), // SPD 2 DOWN (SELECTED)
    LEVEL_UP_MOVE(11, MOVE_DRAGON_RAGE), // 40 DMG (SELECTED)
    LEVEL_UP_MOVE(15, MOVE_DRAGON_CLAW), // 80 (SELECTED)
    LEVEL_UP_MOVE(17, MOVE_FIRE_FANG), // 70 (SELECTED)
    LEVEL_UP_MOVE(19, MOVE_AIR_SLASH), // 75 (SELECTED) F
    LEVEL_UP_MOVE(24, MOVE_SHADOW_CLAW), // 70 (SELECTED) G
    LEVEL_UP_MOVE(27, MOVE_SLASH), // 70 (SELECTED) N
    LEVEL_UP_MOVE(31, MOVE_CUT), // 90 (SELECTED) B
    LEVEL_UP_MOVE(31, MOVE_SWORDS_DANCE), // ATK UP
    LEVEL_UP_MOVE(34, MOVE_FLAMETHROWER), // 100 (SELECTED)
    LEVEL_UP_MOVE(38, MOVE_FIRE_SPIN), // 35 (SELECTED) TRAP,
    LEVEL_UP_MOVE(42, MOVE_HEAT_WAVE), // 90 (BOTH) BURN
    LEVEL_UP_MOVE(45, MOVE_FLARE_BLITZ), // 120 (SELECTED) May Burn
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCharizardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_SLASH), // 70 (SELECTED) N
    LEVEL_UP_MOVE(31, MOVE_CUT), // 90 (SELECTED) B
    LEVEL_UP_MOVE(31, MOVE_SWORDS_DANCE), // 90 (SELECTED) B
    LEVEL_UP_MOVE(34, MOVE_FLAMETHROWER), // 100 (SELECTED)
    LEVEL_UP_MOVE(38, MOVE_FIRE_SPIN), // 35 (SELECTED) TRAP,
    LEVEL_UP_MOVE(42, MOVE_HEAT_WAVE), // 90 (BOTH) BURN
    LEVEL_UP_MOVE(45, MOVE_FLARE_BLITZ), // 120 (SELECTED) May Burn
...
static const struct LevelUpMove sSquirtleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE), // 50 (SELECTED) N
    LEVEL_UP_MOVE( 3, MOVE_TAIL_WHIP), // DEF DOWN
    LEVEL_UP_MOVE( 5, MOVE_BUBBLE), // 50 (SELECTED)
    LEVEL_UP_MOVE( 7, MOVE_WITHDRAW), // DEF UP (BOTH)
    LEVEL_UP_MOVE( 7, MOVE_TAIL_WHIP), // DEF DOWN (BOTH)
    LEVEL_UP_MOVE( 9, MOVE_FLASH_CANNON), // 80 (SELECTED) STEEL
    LEVEL_UP_MOVE(11, MOVE_RAIN_DANCE), // Let it rain
    LEVEL_UP_MOVE(11, MOVE_BITE), // 60 (SELECTED) DARK
    LEVEL_UP_MOVE(15, MOVE_WATER_GUN), // 60 (BOTH)
    LEVEL_UP_MOVE(17, MOVE_RAPID_SPIN), // 60 (SELECTED) N & SPD UP
    LEVEL_UP_MOVE(19, MOVE_PROTECT), // Protect next Move
    LEVEL_UP_MOVE(24, MOVE_WATER_PULSE), // 60 (BOTH) & Confuse
    LEVEL_UP_MOVE(27, MOVE_AQUA_TAIL), // 90 (SELECTED)
    LEVEL_UP_MOVE(31, MOVE_IRON_TAIL), // 100 (SELECTED) & DEF Down
    LEVEL_UP_MOVE(31, MOVE_IRON_DEFENSE), // DEF Up 2
    LEVEL_UP_MOVE(34, MOVE_SKULL_BASH), // 130 (SELECTED) N 2 Turns
    LEVEL_UP_MOVE(38, MOVE_SURF), // 90 (BOTH)
    LEVEL_UP_MOVE(42, MOVE_ICE_BEAM), // 100 (SELECTED) ICE
    LEVEL_UP_MOVE(45, MOVE_HYDRO_PUMP), // 120 (SELECTED)
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHitmonchanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_COMET_PUNCH), // 20 (SELECTED) N 2-5 Times
    LEVEL_UP_MOVE( 3, MOVE_REVENGE), // 60 (SELECTED)
    LEVEL_UP_MOVE( 5, MOVE_STORM_THROW), // 50 (SELECTED)
    LEVEL_UP_MOVE( 7, MOVE_AGILITY), // SPD UP 2
    LEVEL_UP_MOVE( 9, MOVE_FEINT), // 60 (SELECTED) NO Fail
    LEVEL_UP_MOVE(11, MOVE_PURSUIT), // 50 (SELECTED) Dark
    LEVEL_UP_MOVE(15, MOVE_BULLET_PUNCH), // 50 (SELECTED) Metall
    LEVEL_UP_MOVE(17, MOVE_MACH_PUNCH), // 70 (SELECTED)
    LEVEL_UP_MOVE(19, MOVE_VACUUM_WAVE), // 60 (SELECTED) First Strike
    LEVEL_UP_MOVE(24, MOVE_DRAIN_PUNCH), // 75 (SELECTED) Fighting Heal
    LEVEL_UP_MOVE(27, MOVE_FIRE_PUNCH), // 80 (SELECTED) FIRE may BURN
    LEVEL_UP_MOVE(27, MOVE_ICE_PUNCH), // 80 (SELECTED) ICE may FREEZE
    LEVEL_UP_MOVE(27, MOVE_THUNDER_PUNCH), // 80 (SLECTED) Electro may PARALYSIS
    LEVEL_UP_MOVE(31, MOVE_SKY_UPPERCUT), // 80 (SELECTED) Fly may flinch
    LEVEL_UP_MOVE(31, MOVE_DIZZY_PUNCH), // 80 (SELECTED) may CONFUSION
    LEVEL_UP_MOVE(34, MOVE_MEGA_PUNCH), // 100 (SELECTED)
    LEVEL_UP_MOVE(38, MOVE_DETECT), // SHIELD
    LEVEL_UP_MOVE(42, MOVE_COUNTER), // Reflect Hit with 2x DMG
    LEVEL_UP_MOVE(45, MOVE_CLOSE_COMBAT), // 120 -DEF/SPDEF Down
    LEVEL_UP_MOVE(48, MOVE_FOCUS_PUNCH), // 150 2 Turns
    LEVEL_UP_END
};
